        ...
        App.prototype.activate = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.router.configure(this.routerService.configure)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 4:
                            ...
                            console.log(err_1);
                            return [3 /*break*/, 5];
                        case 5: return [2 /*return*/, new Response(content["Status"] ? content["Status"] : response.status, content["StatusText"] ? content["StatusText"] : response.statusText, content)];
                    }
                });
            });
        };
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.adminRequestCallback(authToken)];
                        case 1:
                            isAdmin = _a.sent();
    ...
    var AuthClient = (function () {
        function AuthClient(restService, authService) {
            ...
            this.authService.setAdminRequestCallback(function (authToken) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authorize("admin", authToken)];
                        case 1:
                            result = _a.sent();
        ...
        AuthClient.prototype.login = function (userId, password) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.restService.post(this.serviceUrl + "/api/login", {
                                userId: userId,
                                password: password
                            })];
                        case 1:
                            ...
                            return [2 /*return*/, !response.IsError];
                    }
                });
            });
        };
        AuthClient.prototype.authorize = function (role, authToken) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.restService.post(this.serviceUrl + "/api/authenticate", {
                                role: role,
                                authToken: authToken
                            })];
                        case 1:
    ...
    var ShellCustomElement = (function () {
        ...
        ShellCustomElement.prototype.attached = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.requestAdminAuthorization()];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.authClient.login(this.userId, this.password)];
                        case 1:
                            response = _a.sent();
                            if (!response) {
    ...
    var PickClient = (function () {
        ...
        PickClient.prototype.getCurrentPickInfo = function (userId) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.restService.post(this.serviceUrl + "/api/getGolfers", userId ? { userId: userId } : null, {
        ...
        PickClient.prototype.getPickForCurrent = function (tournamentIndex) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.restService.post(this.serviceUrl + "/api/getPicks", {
        ...
        PickClient.prototype.pickGolfer = function (playerId, playerName) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.restService.post(this.serviceUrl + "/api/pickGolfer", {
        ...
        PickClient.prototype.emergencyPick = function (playerId, playerName, email, userId) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.restService.post(this.serviceUrl + "/api/emergencyPick", {
        ...
        PickClient.prototype.getPickSummary = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.restService.post(this.serviceUrl + "/api/getPickSummary", {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            _a = this;
                            return [4 /*yield*/, this.pickClient.getCurrentPickInfo()];
                        case 1:
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.pickClient.emergencyPick(this.selectedGolfer["TournamentPlayerId"], this.selectedGolfer["PlayerName"], this.selectedProfile["Email"], this.selectedProfile["UserId"])];
                        case 1:
                            response = _a.sent();
                            return [2 /*return*/];
                    }
...
define('microservices/picks/pick-summary',["require", "exports", "aurelia-framework", "./pickClient"], function (require, exports, aurelia_framework_1, pickClient_1) {
    "use strict";
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = this;
                            return [4 /*yield*/, this.pickClient.getPickSummary()];
                        case 1:
                            _a.picks = _b.sent();
                            return [2 /*return*/];
                    }
    ...
    var PicksMainCustomElement = (function () {
        ...
        PicksMainCustomElement.prototype.attached = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.pickClient.getCurrentPickInfo()];
                        case 1:
                            data = _a.sent();
                            this.tournament = data["Tournament"];
                            this.golfers = data["Golfers"];
                            return [4 /*yield*/, this.pickClient.getPickForCurrent(this.tournament["Index"])];
                        case 2:
                            pickData = _a.sent();
                            if (pickData["empty"]) {
                                this.pick = 'none';
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.pickClient.pickGolfer(this.selectedPlayer["TournamentPlayerId"], this.selectedPlayer["PlayerName"])];
                        case 1:
                            response = _a.sent();
                            return [4 /*yield*/, this.pickClient.getPickForCurrent(this.tournament["Index"])];
                        case 2:
    ...
    var StatsClient = (function () {
        ...
        StatsClient.prototype.getTournamentStats = function (season, tour, key, value) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.restService.post(this.serviceUrl + "/api/getTournament", {
        ...
        StatsClient.prototype.getMonthlyStats = function (season, tour, key) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.restService.post(this.serviceUrl + "/api/getMonthly", {
    ...
    var TournamentsClient = (function () {
        ...
        TournamentsClient.prototype.getSeason = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.restService.post(this.serviceUrl + "/api/Season", {
                                Authorization: "Bearer " + this.authService.getWebToken().authToken
                            })];
                        case 1:
                            response = _a.sent();
        ...
        TournamentsClient.prototype.getTournaments = function (season, tour, key) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.restService.post(this.serviceUrl + "/api/getTournaments", {
                                season: season, tour: tour, key: key
                            }, {
                                Authorization: "Bearer " + this.authService.getWebToken().authToken
                            })];
        ...
        TournamentsClient.prototype.getAvailableTournaments = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.getTournaments()];
                        case 1:
                            tournaments = _a.sent();
                            filtered = [];
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = this;
                            return [4 /*yield*/, this.tournamentsClient.getAvailableTournaments()];
                        case 1:
    ...
    var UsersClient = (function () {
        ...
        UsersClient.prototype.setProfile = function (profileData) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.restService.post(this.serviceUrl + "/api/setProfile", null, {
                                Authorization: "Bearer " + this.authService.getWebToken().authToken
                            }, profileData)];
                        case 1:
                            response = _a.sent();
        ...
        UsersClient.prototype.getProfile = function (key, value) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.restService.post(this.serviceUrl + "/api/getProfile", {
                                key: key, value: value
                            }, {
                                Authorization: "Bearer " + this.authService.getWebToken().authToken
                            })];
        ...
        UsersClient.prototype.getRegistration = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.restService.post(this.serviceUrl + "/api/getRegistration", null, {
                                Authorization: "Bearer " + this.authService.getWebToken().authToken
                            })];
                        case 1:
                            response = _a.sent();
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = this;
                            return [4 /*yield*/, this.usersClient.getRegistration()];
                        case 1:
...
define('microservices/stats/current/current-stats',["require", "exports", "aurelia-framework", "../statsClient", "../../../resources/services/eventService"], function (require, exports, aurelia_framework_1, statsClient_1, eventService_1) {
    ...
    var CurrentStatsCustomElement = (function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            console.log(data);
                            this.tournament = null;
                            if (!(data == 'Current')) return [3 /*break*/, 2];
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, this.getData(data["Index"])];
                        case 3:
                            _a.sent();
                            _a.label = 4;
        ...
        CurrentStatsCustomElement.prototype.setupTables = function () {
            var _this = this;
            window.setTimeout(function () {
                $('#pooliestable').dataTable(_this.getPooliesConfig());
                $('#golferstable').dataTable(_this.getGolfersConfig());
                $('input').addClass("form-control input-sm");
            }, 1000);
        };
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            _a = this;
                            return [4 /*yield*/, this.statsClient.getSpecificTournamentStats(index)];
                        case 1:
                            _a.tournament = _c.sent();
                            return [3 /*break*/, 4];
                        case 2:
                            _b = this;
                            return [4 /*yield*/, this.statsClient.getTournamentStats()];
                        case 3:
...
define('microservices/stats/majors/majors-stats',["require", "exports"], function (require, exports) {
    "use strict";
    var MajorsStatsCustomElement = (function () {
        function MajorsStatsCustomElement() {
        }
    ...
    var MonthlyStatsCustomElement = (function () {
        ...
        MonthlyStatsCustomElement.prototype.getData = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.statsClient.getMonthlyStats()];
                        case 1:
                            data = _a.sent();
                            this.poolies = data;
